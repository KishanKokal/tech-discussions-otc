...
const SYSTEM_MESSAGE = `Given a transcript of a video meeting, generate a summary of the query in the following format, skip the links to the speakers twitter, only add their names:
==== Topics Discussed
