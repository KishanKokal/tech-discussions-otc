...
export const Navbar = () => {
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-black-100 rounded-lg bg-black-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white text-black ">
            ...
            <li>
            <a href="#" class="block py-2 px-3 text-black-900 rounded hover:bg-black-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text:black md:dark:hover:text-blue-500 dark:hover:bg-black-700 dark:hover:text-white md:dark:hover:bg-transparent"><Link to="">Upcoming Meet</Link></a>
            </li>
            <li>
            <a href="#" class="block py-2 px-3 text-black-900 rounded hover:bg-black-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text:black md:dark:hover:text-blue-500 dark:hover:bg-black-700 dark:hover:text-white md:dark:hover:bg-transparent"><Link to="">Previos Meet</Link></a>
            </li>
            <li>
